...
class IndexMgr {
   ...
   public IndexMgr(boolean isnew, TableMgr tblmgr, StatMgr statmgr, Transaction tx) {
      if (isnew) {
         ...
         sch.addStringField("indexmethod", MAX_NAME);
    ...
    */
   public void createIndex(String idxname, String tblname, String fldname, Transaction tx, String indexmethod) {
      ...
      ts.setString("indexmethod", indexmethod);
      ts.close();
   }
   ...
   public Map<String,IndexInfo> getIndexInfo(String tblname, Transaction tx) {
      ...
      while (ts.next())
         ...
         indexmethod = ts.getString("indexmethod");
         
         Layout tblLayout = tblmgr.getLayout(tblname, tx);
         StatInfo tblsi = statmgr.getStatInfo(tblname, tblLayout, tx);
         IndexInfo ii = new IndexInfo(idxname, fldname, tblLayout.schema(), tx, tblsi, indexmethod);
