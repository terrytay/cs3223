...
public class IndexInfo {
   private String idxname, fldname, indexmethod;
   ...
   public IndexInfo(String idxname, String fldname, Schema tblSchema,
                    Transaction tx,  StatInfo si, String indexmethod) {
    ...
    */
   public Index open() {
	   return this.indexmethod.equals("hash") ? new HashIndex(tx, idxname, idxLayout) : new BTreeIndex(tx, idxname, idxLayout);
   }
   ...
   public int blocksAccessed() {
      ...
      return this.indexmethod.equals("hash") ? HashIndex.searchCost(numblocks, rpb) : BTreeIndex.searchCost(numblocks, rpb);
   }
